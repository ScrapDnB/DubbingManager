...
4. **Настройка объединения реплик**: кнопка «🔗 Настройки объединения» — параметры применяются ко всем проектам
5. **Экспорт**: настройте параметры и выберите формат (HTML/Excel/Reaper)
